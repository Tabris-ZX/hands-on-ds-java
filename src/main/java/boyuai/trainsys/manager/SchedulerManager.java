...
public class SchedulerManager {
     ...
     *   <li>seat_num: 座位数</li>
     *   <li>start_time: 首发时间（格式 HH:MM，仅时刻无日期）</li>
     ...
     */
    public void addScheduler(FixedString trainID, int seatNum, String startTime, int passingStationNumber, int[] stations, int[] duration, int[] price) throws SQLException {
        ...
        ps.setInt(4, passingStationNumber);
        ps.setString(5, stationStr); // 用逗号串存TEXT
        ps.setString(6, durationStr);
        ps.setString(7, priceStr);
        ps.executeUpdate();
        ps.close();
    }
